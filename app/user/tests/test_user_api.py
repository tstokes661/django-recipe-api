...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        """no token if invalide creds"""
        create_user(email='test@dispensites.com', password='testpass')
        payload = {
            'email': 'test@dispensites.com',
            'password': 'pass',
            'name': 'Test Name'
    ...
    def test_retretrieve_user_unauthorized(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """test updating user as authd user"""
        payload = {
            'name': 'new_name', 'password': 'newpass12234'
        }
